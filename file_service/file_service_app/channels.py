...
class BroadCastWebSocketChannel(BaseNotificationChannel):
    ...
    def notify(self, message):
        ...
        uri = self.notification_kwargs['extra_data']['npm']
        routing = self.notification_kwargs['extra_data']['routing']

        channel.exchange_declare(exchange="1706039780", exchange_type='direct')
        channel.basic_publish(exchange="1706039780", routing_key=routing, body=message)
